...
def loadtrain(ws, percent):
    ...
    with open("./BGL/iforest-train-ws{}.pkl".format(ws), mode="rb") as f:
    ...
    with open("./Thunderbird_sampling/iforest-train-ws{}-per{}.pkl".format(ws, percent), mode="wb") as f:
...
def loadtest(ws):
    ...
    with open("./Thunderbird/iforest-test-ws{}.pkl".format(ws), mode="rb") as f:
    ...
    with open("./Thunderbird_sampling/iforest-test-ws{}.pkl".format(ws), mode="wb") as f:
